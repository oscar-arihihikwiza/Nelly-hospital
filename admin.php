<?php
// admin.php
// Workspace page for Administrator Workspace

require_once 'auth.php';
check_access(['admin']);

$page_title = "Administrator Workspace - HAK Medical";
...
<div class="page" id="pg-dashboard">
        ...
        <!-- Pending appointments alert banner (admin sees this too) -->
        <div id="dash-pending-alert" style="display:none;background:linear-gradient(135deg,#fff3cd,#ffeaa7);border:1.5px solid #ffc107;border-radius:12px;padding:13px 18px;margin-bottom:14px;align-items:center;justify-content:space-between">
          ...
          <button class="btn" style="background:#856404;color:white;border:none;padding:8px 16px;border-radius:8px;font-weight:600;font-size:12px" onclick="nav('appointments');setAF('Pending')">Review Now →</button>
        </div>
...
<div class="page phide" id="pg-billing">
        ...
        <div class="card mb14" id="quick-invoice-card">
          <div class="ch" style="cursor:pointer" onclick="toggleQuickInvoice()">
            ...
            <span style="font-size:12px;color:var(--tx3)">Click to expand</span>
          ...
          <div id="qi-body" style="display:none;padding:18px 20px">
            ...
            <div class="stit" style="margin-bottom:8px">Payments Received <span style="font-weight:400;text-transform:none;letter-spacing:0;color:var(--tx3);font-size:11px">— one row per method or instalment</span></div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:9px;margin-bottom:12px">
              <div style="background:var(--t0);border-radius:var(--r);padding:9px 12px;text-align:center"><div style="font-size:10px;color:var(--t7);text-transform:uppercase;margin-bottom:2px">Total Billed</div><div id="qi-tot2" style="font-family:var(--fs);font-size:16px;font-weight:700;color:var(--t7)">UGX 0</div></div>
              <div style="background:var(--okb);border-radius:var(--r);padding:9px 12px;text-align:center"><div style="font-size:10px;color:var(--ok);text-transform:uppercase;margin-bottom:2px">Total Paid</div><div id="qi-pd-disp" style="font-family:var(--fs);font-size:16px;font-weight:700;color:var(--ok)">UGX 0</div></div>
              <div id="qi-bal-card" style="background:var(--erb);border-radius:var(--r);padding:9px 12px;text-align:center"><div id="qi-bal-lbl" style="font-size:10px;color:var(--er);text-transform:uppercase;margin-bottom:2px">Balance Due</div><div id="qi-ba" style="font-family:var(--fs);font-size:16px;font-weight:700;color:var(--er)">UGX 0</div></div>
            </div>
...
<div class="page phide" id="pg-staff">
        <div class="fxb mb12 np">
          <input class="fi" id="staffsrch" placeholder="Search by name or username…" style="width:250px" oninput="renderStaff()">
          <button class="btn btnp" onclick="openAddStaff()"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2"><path d="M7 2v10M2 7h10" stroke-linecap="round"/></svg>Add Staff Member</button>
        </div>
        <div class="card">
          <div class="ch"><h2>Staff & Users Management</h2></div>
          <div class="tw"><table><thead><tr><th>#</th><th>Username</th><th>Full Name</th><th>Role</th><th>Created At</th><th></th></tr></thead><tbody id="stafftb"></tbody></table></div>
        </div>
      </div>
